...
public class Clock extends Application {
	...
	public void start(final Stage stage) throws Exception {
		...
		face.setId("face");
		final Label brand = new Label("GAYE FARBA");
		brand.setId("brand");
		...
		analogueClock.setOnMouseClicked(new EventHandler<MouseEvent>() {
			...
			public void handle(MouseEvent mouseEvent) {
				...
				FadeTransition fade = new FadeTransition(Duration.seconds(5.2), analogueClock);
		...
		scene.getStylesheets().add(getResource("NewFile.css"));
